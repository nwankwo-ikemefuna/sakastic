<div class="comment_wrapper">
	<div class="mt-2">
		<?php 
		post_avatar('<a class="text-primary text-bold clickable comment_title" data-toggle="collapse" data-target="#comment_add_'.$pc_id.'">Add a '.$reply_type.'</a>'); ?>
	...
	<h6 id="comments_info_<?php echo $pc_id; ?>" class="comment_title mt-2"></h6>
